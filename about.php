...
<body>
    ...
    <section class="hero" id="home" data-aos="fade-up">
        <div class="hero-content">
            <h1 data-aos="zoom-in">Welcome to AGRI-CURE</h1>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-section about">
                <h3>About AGRI-CURE</h3>
                <p>AGRI-CURE is dedicated to empowering farmers with sustainable solutions, promoting agroecological practices, and enhancing rural livelihoods through innovative training and networking opportunities.</p>
            </div>

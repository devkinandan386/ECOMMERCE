                ...
                <div class="row row2">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">यूआई/यूएक्स डिज़ाइन</h4>
                                <p class="card-text">प्रभावी यूएक्स डिज़ाइन कृषि अनुप्रयोगों और उपकरणों के लिए सगाई और उपयोगिता को सुधारती है।</p>
                            </div>
                        </div>
                    </div>

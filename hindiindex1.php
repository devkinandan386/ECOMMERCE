...
<body>
    ...
    <p style="font-size: 32px; font-weight: bold; color: #4CAF50;">AGRICURE</p>
        ...
        <i class="bi bi-globe" style="font-size: 1.5rem; cursor: pointer;" title="भाषा चुनें"></i>
        </a>         
        <!-- भाषा ड्रॉपडाउन मेनू -->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card">
                            ...
                            <a href="hindiresearch.php"><div class="card-body">
                                ...
                                <p class="card-text">कृषि खाद्य उत्पादन, आर्थिक विकास और पर्यावरणीय स्थिरता में महत्वपूर्ण भूमिका निभाती है, नवीन प्रथाओं के माध्यम से।</p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card">
                            ...
                            <a href="hindibranding.php"><div class="card-body">
                                ...
                                <p class="card-text">कृषि में प्रभावी ब्रांडिंग उत्पाद की पहचान को बढ़ाती है, उपभोक्ता विश्वास का निर्माण करती है और एक वफादार ग्राहक आधार को बढ़ावा देती है।</p>
                            </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">सतत कृषि विकास भविष्य की पीढ़ियों के लिए उत्पादकता में सुधार, खाद्य सुरक्षा सुनिश्चित करना और पर्यावरण संरक्षण पर केंद्रित है।</p>
                            </div>
                        </div>
                    </div>
                </div>
